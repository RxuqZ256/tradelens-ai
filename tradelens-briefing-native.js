(function(){
  ...
  function ensureStyles(){
    ...
    style.textContent=[
      ...
      ".tl-reference-main{display:grid;grid-template-columns:minmax(0,1fr) 150px;gap:8px;align-items:center;min-height:170px}",
      ...
      ".tl-reference-visual{position:relative;display:flex;align-items:center;justify-content:center;min-height:170px;z-index:1;overflow:visible}",
      ".tl-reference-visual:before{content:'';position:absolute;inset:3px -14px;background:radial-gradient(circle at 50% 48%,rgba(34,247,255,.17),rgba(37,99,235,.08) 42%,transparent 74%);filter:blur(11px)}",
      ".tl-option-b-orb{position:relative;width:142px;height:146px;display:flex;align-items:center;justify-content:center;animation:tlOptionBFloat 5.8s ease-in-out infinite;isolation:isolate}",
      ".tl-option-b-glow{position:absolute;inset:17px;border-radius:50%;background:radial-gradient(circle,rgba(34,247,255,.33),rgba(59,130,246,.14) 52%,transparent 75%);filter:blur(17px);animation:tlOptionBGlow 4s ease-in-out infinite;z-index:0}",
      ".tl-option-b-core{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;z-index:3;filter:drop-shadow(0 0 10px rgba(34,247,255,.38)) drop-shadow(0 0 22px rgba(99,102,241,.21));transform:none!important;animation:none!important}",
      ".tl-option-b-fallback{position:absolute;left:50%;top:46%;width:88px;height:88px;transform:translate(-50%,-50%);border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:var(--f-disp);font-size:28px;font-weight:800;color:#fff;background:radial-gradient(circle at 35% 30%,#dfffff 0 4%,#22d3ee 8%,#1d4ed8 36%,#081229 72%);box-shadow:inset 0 0 24px rgba(34,247,255,.55),0 0 24px rgba(34,247,255,.38);z-index:2}",
      ".tl-option-b-orbits{position:absolute;inset:0;z-index:6;pointer-events:none}",
      ".tl-option-b-group{position:absolute;inset:0;transform-origin:50% 48%}",
      ...
      ".tl-option-b-ring{position:absolute;left:50%;top:48%;border-radius:50%;border:1px solid rgba(140,240,255,.42);box-shadow:0 0 9px rgba(34,247,255,.15);transform:translate(-50%,-50%)}",
      ".tl-option-b-ring.r1{width:126px;height:42px;transform:translate(-50%,-50%) rotate(12deg)}",
      ".tl-option-b-ring.r2{width:108px;height:32px;transform:translate(-50%,-50%) rotate(62deg);border-color:rgba(167,139,250,.38)}",
      ".tl-option-b-ring.r3{width:70px;height:116px;transform:translate(-50%,-50%) rotate(24deg);border-color:rgba(255,255,255,.18)}",
      ".tl-option-b-ring.r4{width:132px;height:27px;transform:translate(-50%,-50%) rotate(-18deg);border-style:dashed;border-color:rgba(34,247,255,.24)}",
      ".tl-option-b-ring.r5{width:96px;height:24px;transform:translate(-50%,-50%) rotate(110deg);border-color:rgba(201,255,255,.24)}",
      ".tl-option-b-ring.r6{width:118px;height:22px;transform:translate(-50%,-50%) rotate(148deg);border-color:rgba(34,211,238,.20)}",
      ".tl-option-b-dot{position:absolute;width:5px;height:5px;border-radius:50%;background:#efffff;box-shadow:0 0 8px #fff,0 0 15px rgba(34,247,255,.9)}",
      ".tl-option-b-dot.d1{left:15px;top:48px}",
      ".tl-option-b-dot.d2{right:17px;top:38px;width:4px;height:4px}",
      ".tl-option-b-dot.d3{left:38px;bottom:28px;width:4px;height:4px}",
      ".tl-option-b-dot.d4{right:35px;bottom:25px}",
      ".tl-option-b-dot.d5{left:68px;top:17px;width:4px;height:4px}",
      ".tl-option-b-base-glow{position:absolute;left:50%;bottom:6px;width:108px;height:18px;transform:translateX(-50%);border-radius:50%;background:radial-gradient(ellipse at center,rgba(34,247,255,.43),rgba(37,99,235,.19) 54%,transparent 78%);filter:blur(7px);z-index:1}",
      ...
      "@media(max-width:360px){.tl-reference-main{grid-template-columns:minmax(0,1fr) 132px;gap:6px}.tl-option-b-orb{width:126px;height:130px}.tl-option-b-ring.r1{width:112px}.tl-option-b-ring.r4{width:118px}.tl-native-title{font-size:14px;letter-spacing:1.6px}.tl-native-summary{font-size:12px}}"
    ].join("\n");
  ...
  function render(){
    ...
    box.innerHTML="<div class='tl-native-briefing'><div class='tl-reference-main'><div class='tl-reference-copy'><div class='tl-native-title'>AI DAILY BRIEFING</div><div class='tl-native-date'>"+dateText()+"</div><div class='tl-native-kicker'>Marktüberblick</div><div class='tl-native-summary'>Die Live-Daten für dein ausgewähltes Briefing werden geladen.</div><div class='tl-native-focus'>Sobald die Marktdaten verfügbar sind, wird der Marktüberblick automatisch aktualisiert.</div></div><div class='tl-reference-visual'><div class='tl-option-b-orb'><span class='tl-option-b-glow'></span><span class='tl-option-b-base-glow'></span>"+imageMarkup+"<div class='tl-option-b-orbits'><div class='tl-option-b-group g1'><span class='tl-option-b-ring r1'></span><span class='tl-option-b-ring r3'></span><span class='tl-option-b-dot d1'></span><span class='tl-option-b-dot d3'></span></div><div class='tl-option-b-group g2'><span class='tl-option-b-ring r2'></span><span class='tl-option-b-ring r5'></span><span class='tl-option-b-dot d2'></span><span class='tl-option-b-dot d5'></span></div><div class='tl-option-b-group g3'><span class='tl-option-b-ring r4'></span><span class='tl-option-b-ring r6'></span><span class='tl-option-b-dot d4'></span></div></div></div></div></div><div class='tl-native-actions'><button class='tl-native-analyse' type='button'>Analyse starten ›</button><button class='tl-native-settings' type='button' aria-label='Daily Briefing Einstellungen'>⚙</button></div></div>";
